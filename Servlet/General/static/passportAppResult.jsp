        ...
        <div>
            <table class="table table-bordered    table-light table-striped ">
                ...
                <tr>
                    ...
                    <td>${passport.adharName}</td>

                </tr>
                <tr>
                    <th scope="row">Pan Number</th>
                    <td>${passport.panName}</td>

                </tr>
                <tr>
                    <th scope="row">Passport Type</th>
                    <td>${passport.passporttypeName}</td>

                </tr>
                <tr>
                    <th scope="row">Address</th>
                    <td>${passport.addressName}</td>
                ...
                <tr>
                    ...
                    <td>${passport.stateName}</td>

                </tr>
                <tr>
                    <th scope="row">City </th>
                    <td>${passport.cityName}</td>

                </tr>
                <tr>
                    <th scope="row">Pin Code </th>
                    <td>${passport.pinName}</td>

                </tr>
                <tr>
                    <th scope="row">Payment Reference No </th>
                    <td>${passport.paymentName}</td>
