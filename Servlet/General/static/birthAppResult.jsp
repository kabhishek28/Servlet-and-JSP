        ...
        <div>
            <table class="table table-bordered    table-light table-striped ">
                ...
                <tr>
                    ...
                    <td>${birthApplicationDTO.birthID}</td>

                </tr>
                <tr>
                    <th scope="row">Father Name</th>
                    <td>${birthApplicationDTO.fatherName}</td>

                </tr>
                <tr>
                    <th scope="row">Mother Name</th>
                    <td>${birthApplicationDTO.motherName}</td>

                </tr>
                <tr>
                    <th scope="row">Date and Time</th>
                    <td>${birthApplicationDTO.datetime}</td>

                </tr>
                <tr>
                    <th scope="row">Doctor Name</th>
                    <td>${birthApplicationDTO.doctorName}</td>

                </tr>
                <tr>
                    <th scope="row">Nurse Name</th>
                    <td>${birthApplicationDTO.nurseName}</td>

                </tr>
                <tr>
                    <th scope="row">Hospital Name</th>
                    <td>${birthApplicationDTO.hospitalName}</td>

                </tr>
                <tr>
                    <th scope="row">Hospital Type</th>
                    <td>${birthApplicationDTO.hospitaltype}</td>
