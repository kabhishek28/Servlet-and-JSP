        ...
        <div>
            <table class="table table-bordered    table-light table-striped ">
                ...
                <tr>
                    ...
                    <td>${marriage.groomName}</td>

                </tr>

                <tr>
                    <th scope="row">Bride Name</th>
                    <td>${marriage.brideName}</td>

                </tr>

                <tr>
                    <th scope="row">Marriage Location</th>
                ...
                <tr>
                    <th scope="row">Officer Present</th>
                    <td>${marriage.officerPresent}</td>

                </tr>

                <tr>
                    <th scope="row">Witness 1  </th>
                    <td>${marriage.witness1}</td>
                </tr>

                <tr>
                    <th scope="row">Witness 2  </th>
                    <td>${marriage.witness2}</td>
                </tr>
